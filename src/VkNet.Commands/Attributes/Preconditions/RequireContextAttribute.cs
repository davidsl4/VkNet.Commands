...
namespace VkNet.Commands.Attributes.Preconditions
{
    /// <summary>
    ...
    public enum ContextType
    {
        ...
        DM = 0x01,
        /// <summary>
        ///     Specifies the command to be executed within a chat.
        /// </summary>
        Chat = 0x02
    }
    ...
    public class RequireContextAttribute : PreconditionAttribute
    {
        ...
        public override Task<PreconditionResult> CheckPermissionsAsync(ICommandContext context, CommandInfo command, IServiceProvider services)
        {
            ...
            if ((Contexts & ContextType.Chat) != 0)
                isValid = context.PeerId > 2000000000;
            if ((Contexts & ContextType.DM) != 0)
                isValid = isValid || context.PeerId <= 2000000000;
