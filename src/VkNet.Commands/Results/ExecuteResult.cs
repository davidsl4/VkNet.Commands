...
namespace VkNet.Commands.Results
{
    /// <summary>
    ...
    public struct ExecuteResult : IResult
    {
        ...
        private ExecuteResult(System.Exception exception, CommandError? error, string errorReason)
        {
            Exception = exception;
            Error = error;
        ...
        ///     reason.
        /// </returns>
        public static ExecuteResult FromError(System.Exception ex)
